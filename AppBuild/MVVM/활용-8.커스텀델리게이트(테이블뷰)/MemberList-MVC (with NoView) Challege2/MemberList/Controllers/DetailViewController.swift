...
//        }
        ...
        memberIdTextField.text = viewModel.memberIdString
        nameTextField.text = viewModel.nameString
        phoneNumberTextField.text = viewModel.phoneString
...
//        }
        ...
        viewModel.handleButtonTapped(image: image, name: name, age: age, phone: phoneNumber, address: address)
